...
#define HAVE_ATTR_lmbd_zext_op1_subst 1
extern enum attr_lmbd_zext_op1_subst get_attr_lmbd_zext_op1_subst (rtx_insn *);

#define HAVE_ATTR_lmbd_zext_op2_subst 1
extern enum attr_lmbd_zext_op2_subst get_attr_lmbd_zext_op2_subst (rtx_insn *);

#define HAVE_ATTR_lmbd_zext_subst 1
extern enum attr_lmbd_zext_subst get_attr_lmbd_zext_subst (rtx_insn *);
