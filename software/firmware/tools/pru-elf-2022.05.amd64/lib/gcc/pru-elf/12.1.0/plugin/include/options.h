...
#define TARGET_EXPLICIT_MINRT_P(opts) ((opts->x_target_flags_explicit & MASK_MINRT) != 0)
#define SET_TARGET_MINRT(opts) opts->x_target_flags |= MASK_MINRT
/* OPT_LOOP mask */
#define TARGET_OPT_LOOP ((target_flags & MASK_OPT_LOOP) != 0)
#define TARGET_OPT_LOOP_P(target_flags) (((target_flags) & MASK_OPT_LOOP) != 0)
#define TARGET_EXPLICIT_OPT_LOOP_P(opts) ((opts->x_target_flags_explicit & MASK_OPT_LOOP) != 0)
#define SET_TARGET_OPT_LOOP(opts) opts->x_target_flags |= MASK_OPT_LOOP
...
enum opt_code
{
  ...
  OPT_list = 1763,                           /* -list */
  OPT_mabi_ = 1764,                          /* -mabi= */
  OPT_minrt = 1765,                          /* -minrt */
  OPT_mloop = 1766,                          /* -mloop */
  OPT_mmcu_ = 1767,                          /* -mmcu= */
  OPT_mno_relax = 1768,                      /* -mno-relax */
  OPT_n = 1769,                              /* -n */
  OPT_name_sort = 1770,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1771,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1772,              /* -no-integrated-cpp */
  OPT_no_pie = 1773,                         /* -no-pie */
  OPT_nocpp = 1774,                          /* -nocpp */
  OPT_nodefaultlibs = 1775,                  /* -nodefaultlibs */
  OPT_nolibc = 1776,                         /* -nolibc */
  OPT_nophoboslib = 1777,                    /* -nophoboslib */
  OPT_nostartfiles = 1778,                   /* -nostartfiles */
  OPT_nostdinc = 1779,                       /* -nostdinc */
  OPT_nostdinc__ = 1780,                     /* -nostdinc++ */
  OPT_nostdlib = 1781,                       /* -nostdlib */
  OPT_o = 1782,                              /* -o */
  OPT_objects = 1783,                        /* -objects */
  OPT_p = 1784,                              /* -p */
  OPT_pass_exit_codes = 1785,                /* -pass-exit-codes */
  /* OPT_pedantic = 1786, */                 /* -pedantic */
  OPT_pedantic_errors = 1787,                /* -pedantic-errors */
  OPT_pg = 1788,                             /* -pg */
  OPT_pie = 1789,                            /* -pie */
  OPT_pipe = 1790,                           /* -pipe */
  OPT_print_file_name_ = 1791,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1792,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1793,          /* -print-multi-directory */
  OPT_print_multi_lib = 1794,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1795,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1796,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1797,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1798,               /* -print-prog-name= */
  OPT_print_search_dirs = 1799,              /* -print-search-dirs */
  OPT_print_sysroot = 1800,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1801,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1802,                    /* -print-value */
  OPT_quiet = 1803,                          /* -quiet */
  OPT_r = 1804,                              /* -r */
  OPT_remap = 1805,                          /* -remap */
  OPT_reverse_sort = 1806,                   /* -reverse-sort */
  OPT_s = 1807,                              /* -s */
  OPT_save_temps = 1808,                     /* -save-temps */
  OPT_save_temps_ = 1809,                    /* -save-temps= */
  OPT_shared = 1810,                         /* -shared */
  OPT_shared_libgcc = 1811,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1812,               /* -shared-libphobos */
  OPT_size_sort = 1813,                      /* -size-sort */
  /* OPT_specs = 1814, */                    /* -specs */
  OPT_specs_ = 1815,                         /* -specs= */
  OPT_static = 1816,                         /* -static */
  OPT_static_libasan = 1817,                 /* -static-libasan */
  OPT_static_libgcc = 1818,                  /* -static-libgcc */
  OPT_static_libgfortran = 1819,             /* -static-libgfortran */
  OPT_static_libgo = 1820,                   /* -static-libgo */
  OPT_static_libhwasan = 1821,               /* -static-libhwasan */
  OPT_static_liblsan = 1822,                 /* -static-liblsan */
  OPT_static_libmpx = 1823,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1824,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1825,               /* -static-libphobos */
  OPT_static_libstdc__ = 1826,               /* -static-libstdc++ */
  OPT_static_libtsan = 1827,                 /* -static-libtsan */
  OPT_static_libubsan = 1828,                /* -static-libubsan */
  OPT_static_pie = 1829,                     /* -static-pie */
  /* OPT_std_c__03 = 1830, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1831, */                /* -std=c++0x */
  OPT_std_c__11 = 1832,                      /* -std=c++11 */
  OPT_std_c__14 = 1833,                      /* -std=c++14 */
  OPT_std_c__17 = 1834,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1835, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1836, */                /* -std=c++1z */
  OPT_std_c__20 = 1837,                      /* -std=c++20 */
  OPT_std_c__23 = 1838,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1839, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1840, */                /* -std=c++2b */
  OPT_std_c__98 = 1841,                      /* -std=c++98 */
  OPT_std_c11 = 1842,                        /* -std=c11 */
  OPT_std_c17 = 1843,                        /* -std=c17 */
  /* OPT_std_c18 = 1844, */                  /* -std=c18 */
  /* OPT_std_c1x = 1845, */                  /* -std=c1x */
  OPT_std_c2x = 1846,                        /* -std=c2x */
  /* OPT_std_c89 = 1847, */                  /* -std=c89 */
  OPT_std_c90 = 1848,                        /* -std=c90 */
  OPT_std_c99 = 1849,                        /* -std=c99 */
  /* OPT_std_c9x = 1850, */                  /* -std=c9x */
  OPT_std_f2003 = 1851,                      /* -std=f2003 */
  OPT_std_f2008 = 1852,                      /* -std=f2008 */
  OPT_std_f2008ts = 1853,                    /* -std=f2008ts */
  OPT_std_f2018 = 1854,                      /* -std=f2018 */
  OPT_std_f95 = 1855,                        /* -std=f95 */
  OPT_std_gnu = 1856,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1857, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1858, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1859,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1860,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1861,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1862, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1863, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 1864,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 1865,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 1866, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 1867, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 1868,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1869,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1870,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1871, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1872, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1873,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1874, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1875,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1876,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1877, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1878, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1879,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1880, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1881, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1882, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1883, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1884, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1885,                     /* -std=legacy */
  OPT_stdlib_ = 1886,                        /* -stdlib= */
  OPT_symbol_ = 1887,                        /* -symbol= */
  OPT_symbolic = 1888,                       /* -symbolic */
  OPT_t = 1889,                              /* -t */
  OPT_time = 1890,                           /* -time */
  OPT_time_ = 1891,                          /* -time= */
