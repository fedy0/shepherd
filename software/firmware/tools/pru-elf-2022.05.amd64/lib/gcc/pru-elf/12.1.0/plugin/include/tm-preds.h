/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/mnt/hdd/dinux/misc/pru/.build/pru-elf/src/gcc/gcc/config/pru/pru.md'.  */
...
extern bool const_ubyte_operand (rtx, machine_mode);
extern bool const_uhword_operand (rtx, machine_mode);
extern bool pru_cmp_operator (rtx, machine_mode);
extern bool pru_signed_cmp_operator (rtx, machine_mode);
extern bool pru_fp_comparison_operator (rtx, machine_mode);
extern bool single_one_operand (rtx, machine_mode);
extern bool single_zero_operand (rtx, machine_mode);
extern bool pru_muldst_operand (rtx, machine_mode);
extern bool pru_mulsrc0_operand (rtx, machine_mode);
extern bool pru_mulsrc1_operand (rtx, machine_mode);
extern bool regio_operand (rtx, machine_mode);
extern bool reg_or_const_int_operand (rtx, machine_mode);
extern bool reg_or_ubyte_operand (rtx, machine_mode);
extern bool reg_or_const_1_operand (rtx, machine_mode);
extern bool const_shift_operand (rtx, machine_mode);
extern bool shift_operand (rtx, machine_mode);
extern bool ctable_addr_operand (rtx, machine_mode);
extern bool ctable_base_operand (rtx, machine_mode);
...
{
  return c >= CONSTRAINT_r && c <= CONSTRAINT_Rrio;
}
