...
enum attr_lmbd_zext_op1_subst {LMBD_ZEXT_OP1_SUBST_NO, LMBD_ZEXT_OP1_SUBST_YES};
enum attr_lmbd_zext_op2_subst {LMBD_ZEXT_OP2_SUBST_NO, LMBD_ZEXT_OP2_SUBST_YES};
enum attr_lmbd_zext_subst {LMBD_ZEXT_SUBST_NO, LMBD_ZEXT_SUBST_YES};
